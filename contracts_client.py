"""USASpending.gov API client — federal contract award history."""
from __future__ import annotations

import time
import requests

from config import USASPENDING_BASE, USASPENDING_RATE_LIMIT, CONTRACT_HIGH_DEP_PCT, CONTRACT_MODERATE_PCT
from models import ContractAward, ContractProfile
from seed_data import DEMO_AWARDS
