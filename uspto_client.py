"""USPTO PatentsView API client — IP portfolio for a given company."""
from __future__ import annotations

import time
import requests

from config import PATENTS_BASE, PATENTS_RATE_LIMIT
from models import IPPortfolio, PatentRecord
from seed_data import DEMO_PATENTS, DEMO_COMPANY
...
def build_ip_portfolio(company: str, raw_patents: list[dict]) -> IPPortfolio:
    ...
    from config import IP_STRONG_MIN, IP_MODERATE_MIN, IP_WEAK_MIN, RECENT_YEARS, BASELINE_YEARS, CPC_DOMAINS
