"""CourtListener API client — litigation history for a given company."""
from __future__ import annotations

import time
import requests

from config import COURTLISTENER_BASE, COURTLISTENER_RATE_LIMIT
from models import LitigationCase, LitigationProfile
from seed_data import DEMO_CASES
...
def _litigation_tier(active: int, ip_disputes: int, reg_actions: int) -> str:
    from config import LIT_CRITICAL_ACTIVE, LIT_ELEVATED_ACTIVE, LIT_ELEVATED_REGULATORY
